# Chocobos Reborn 1.0.0 - Whiskerwind

First public release. Minecraft 1.21.1, NeoForge 21.1.249, Java 21, client and server.
...
- **Racing**: heats every five minutes with on-screen countdown, 24 unique kart-style courses across four classes, boost strips, terrain shortcuts, infield grandstands, AI racers with kin jockeys and per-heat form, duels with side bets, bird trading.
- **Chocobo Farms** in the Overworld with Stablehand and Farmhand; **Chocobo Pocketwatch** to Whiskerwind and back.
