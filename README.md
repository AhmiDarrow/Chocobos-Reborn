...
Final Fantasy VII chocobos for **Minecraft 1.21.1 / NeoForge 21.1.249**. Version **1.0.9**. Catch a wild Yellow with Gysahl Greens, train it on the eight greens, mate it with the eight nuts, walk the farm line to Green, Blue, Black and Gold, then take it to Whiskerwind and race.

[CurseForge](https://www.curseforge.com/minecraft/mc-mods/chocobos-reborn) · [Release 1.0.9](https://github.com/AhmiDarrow/Chocobos-Reborn/releases/tag/v1.0.9)
